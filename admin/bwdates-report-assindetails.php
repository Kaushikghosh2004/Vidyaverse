...
// GET DATES (From POST or previous logic)
$fdate = $_POST['fromdate'] ?? '';
$tdate = $_POST['todate'] ?? '';

// If accessed directly without POST, try to persist dates or redirect
if(empty($fdate) || empty($tdate)) {
    // Optional: Add logic to handle direct access or redirect back to form
}
...
// Count Total for Pagination (Filtered by Date)
$count_sql = "SELECT count(tbluploadass.ID) as total 
              FROM tbluploadass 
              WHERE date(tbluploadass.SubmitDate) BETWEEN :fdate AND :tdate";
$q_count = $dbh->prepare($count_sql);
$q_count->execute(['fdate' => $fdate, 'tdate' => $tdate]);
...
$query->execute(['fdate' => $fdate, 'tdate' => $tdate]);
...
<html lang="en">
<head>
    <title>Report Details | VIDYAVERSE</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .report-date { color: #94a3b8; font-size: 14px; }
...
<body>
    ...
    <div class="simple-header">
        <div class="header-title">
            <i class="ti-files"></i> REPORT RESULTS
        </div>
        <a href="bwdates-assign-report.php" class="btn-back">
    ...
    <div class="main-content">
        ...
        <div class="report-info">
            <h3 class="report-title">Assignment Submission Report</h3>
            <span class="report-date">From: <b><?php echo $fdate; ?></b> To: <b><?php echo $tdate; ?></b></span>
        </div>
        ...
        <div class="result-grid">
            ...
            <div class="res-card">
                ...
                <div class="card-bot">
                    <span style="font-size:12px; color:#64748b;">ID: <?php echo htmlentities($row->AssignmentNumber); ?></span>
                    <a href="view-submission.php?id=<?php echo $row->upid; ?>" class="btn-view">View Details</a>
                </div>
            </div>
            <?php 
                }
            ...
            ?>
                <div class="empty-state">
                    ...
                    <p>No assignment submissions found for the selected dates.</p>
                </div>
            <?php } ?>
        </div>
